...
var questionBank = {
  easy: [
    {
      question:
        "Trong cơ cấu xã hội, nhóm cơ cấu nào có vị trí quan trọng hàng đầu?",
      options: [
      ...
      topic: "Cơ cấu xã hội",
      explanation:
        "Cơ cấu xã hội - giai cấp có vị trí quan trọng hàng đầu vì liên quan đến sở hữu tư liệu sản xuất.",
    ...
    },
    {
      ...
      explanation:
        "Liên minh Công nhân - Nông dân - Trí thức là liên minh cơ bản.",
    ...
    },
    {
      ...
      explanation:
        "Giai cấp công nhân là lực lượng lãnh đạo cách mạng và đại diện cho phương thức sản xuất tiên tiến nhất.",
    ...
    },
    {
      ...
      explanation:
        "Giai cấp nông dân đóng vai trò là bệ đỡ kinh tế, đảm bảo an ninh lương thực và xuất khẩu nông sản.",
    ...
    },
    {
      ...
      topic: "Liên minh giai cấp",
      explanation:
        "Giai cấp công nhân là lực lượng lãnh đạo trong liên minh giai cấp cơ bản.",
    ...
    },
    {
      ...
      topic: "Cơ cấu xã hội",
      explanation:
        "Cơ cấu xã hội bao gồm cơ cấu giai cấp, cơ cấu dân tộc, cơ cấu nghề nghiệp và cơ cấu vùng miền.",
    ...
    },
    {
      ...
      explanation:
        "Cơ cấu giai cấp quy định bản chất của chế độ xã hội và chi phối các cơ cấu khác.",
      hint: "Cơ cấu này liên quan đến 'bản chất' của xã hội.",
    },
    {
      question:
        "Quá trình công nghiệp hóa, hiện đại hóa ở Việt Nam có đặc điểm gì?",
      options: [
      ...
      explanation:
        "Công nghiệp hóa, hiện đại hóa Việt Nam gắn liền với phát triển kinh tế thị trường định hướng xã hội chủ nghĩa.",
      hint: "Quá trình này có tính 'đặc thù' của Việt Nam.",
    },
    {
      question:
        "Theo định nghĩa, “Cơ cấu xã hội là hệ thống các cộng đồng người cùng những mối liên hệ, quan hệ do sự tác động qua lại lẫn nhau tạo thành một chính thể xã hội.” Định nghĩa này nhấn mạnh yếu tố nào?",
      options: [
        "Quyền lực chính trị là yếu tố quyết định duy nhất",
        "Sự tác động qua lại giữa các cộng đồng người",
        "Sự phân chia thuần túy theo độ tuổi và giới tính",
        "Chỉ quan hệ sở hữu tư liệu sản xuất",
      ],
      correct: 1,
      topic: "Cơ cấu xã hội",
      explanation:
        "Định nghĩa này nhấn mạnh sự tác động qua lại giữa các cộng đồng người trong xã hội.",
      hint: "Chú ý đến cụm từ 'tác động qua lại lẫn nhau'.",
    },
  ],
  medium: [
    {
      question:
        "Thành tựu tổng thể của 38 năm Đổi mới cho thấy tỷ lệ thất nghiệp ở Việt Nam hiện duy trì ở mức bao nhiêu?",
      options: ["5–6%", "4%", "2–3%", "Dưới 1%"],
      correct: 2,
      topic: "Thành tựu Đổi mới",
      explanation:
        "Tỷ lệ thất nghiệp ở Việt Nam hiện duy trì ở mức 2–3%, phản ánh sự phát triển kinh tế và ổn định xã hội.",
      hint: "Con số này thể hiện thành quả của chính sách phát triển kinh tế.",
    },
    {
      question:
        "Mặt trận Tổ quốc Việt Nam được xem là gì trong liên minh giai cấp?",
      options: [
        "Công cụ tuyên truyền",
        "Hình thức liên minh cụ thể",
      ...
      topic: "Liên minh giai cấp",
      explanation:
        "Mặt trận Tổ quốc Việt Nam là hình thức liên minh cụ thể giữa các giai cấp, tầng lớp trong xã hội.",
      hint: "Đây là tổ chức đại diện cho khối đại đoàn kết toàn dân.",
    },
    {
      question:
        "Tỷ lệ lao động nông nghiệp của Việt Nam năm 2022 là bao nhiêu?",
      options: ["27.5%", "50%", "70%", "15%"],
      correct: 0,
      topic: "Thống kê kinh tế",
      explanation:
        "Tỷ lệ lao động nông nghiệp giảm từ 70% (1986) xuống 27.5% (2022).",
    ...
    },
    {
      ...
      explanation:
        "Tầng lớp trí thức là lực lượng sáng tạo đặc biệt, động lực quan trọng trong công nghiệp hóa, hiện đại hóa.",
    ...
    },
    {
      ...
      explanation:
        "Tầng lớp doanh nhân mới xuất hiện và phát triển từ thời kỳ Đổi mới 1986 với sự ra đời của kinh tế thị trường.",
      hint: "Tầng lớp này gắn liền với 'kinh tế thị trường'.",
    },
    {
      question:
        "Đặc điểm nổi bật của giai cấp công nhân Việt Nam hiện nay là gì?",
      options: [
      ...
      topic: "Giai cấp công nhân",
      explanation:
        "Giai cấp công nhân Việt Nam không ngừng tăng về số lượng và được nâng cao về trình độ văn hóa, chuyên môn.",
      hint: "Sự phát triển này gắn với công nghiệp hóa, hiện đại hóa.",
    },
    {
      question:
        "Vai trò của tầng lớp trí thức trong sự nghiệp xây dựng đất nước?",
      options: [
      ...
      topic: "Tầng lớp trí thức",
      explanation:
        "Tầng lớp trí thức đóng góp trí tuệ, sáng tạo về khoa học công nghệ cho sự nghiệp phát triển đất nước.",
      hint: "Tầng lớp này liên quan đến 'trí tuệ' và 'sáng tạo'.",
    },
    {
      question:
        "Tầng lớp nông dân Việt Nam có những biến đổi gì trong thời kỳ hiện nay?",
      options: [
      ...
      topic: "Giai cấp nông dân",
      explanation:
        "Tầng lớp nông dân giảm tỷ trọng nhưng tăng trình độ và hiệu quả sản xuất, đa dạng hóa kinh tế.",
    ...
    },
    {
      ...
      explanation:
        "Việt Nam chuyển đổi từ kinh tế kế hoạch hóa tập trung sang kinh tế thị trường định hướng xã hội chủ nghĩa.",
  ...
  hard: [
    {
      question:
        "Theo văn kiện Đại hội IX, đặc điểm cơ cấu giai cấp thời kỳ quá độ là gì?",
      options: [
      ...
      topic: "Văn kiện Đảng",
      explanation:
        "Văn kiện Đại hội IX khẳng định có nhiều giai cấp, tầng lớp khác nhau.",
      hint: "Đây là đặc điểm của xã hội trong thời kỳ chuyển đổi.",
    },
    {
      question:
        "Vai trò của giai cấp công nhân trong liên minh giai cấp là gì?",
      options: [
      ...
      explanation:
        "Giai cấp công nhân là lực lượng lãnh đạo cách mạng, đại diện cho phương thức sản xuất tiên tiến nhất.",
      hint: "Giai cấp này được coi là 'tiên phong' và có tính 'cách mạng triệt để'.",
    },
    {
      question:
        "Tại sao cơ cấu xã hội - giai cấp lại chi phối các cơ cấu xã hội khác?",
      options: [
      ...
      explanation:
        "Cơ cấu giai cấp chi phối các cơ cấu khác vì nó liên quan đến quyền lực chính trị và sở hữu tư liệu sản xuất.",
      hint: "Vấn đề này liên quan đến 'quyền lực' và 'kinh tế'.",
    },
    {
      question:
        "Theo quan điểm của chủ nghĩa xã hội khoa học, mâu thuẫn cơ bản của chủ nghĩa tư bản là gì?",
      options: [
      ...
      explanation:
        "Đây là mâu thuẫn cơ bản nhất của chủ nghĩa tư bản theo lý thuyết Marx, dẫn đến khủng hoảng kinh tế và đấu tranh giai cấp.",
      hint: "Mâu thuẫn này liên quan đến 'sản xuất xã hội' và 'chiếm hữu tư nhân'.",
    },
    {
      question:
        "Tính tất yếu lịch sử của chủ nghĩa xã hội được thể hiện qua điều gì?",
      options: [
      ...
      explanation:
        "Tính tất yếu của CNXH xuất phát từ quy luật phát triển khách quan của xã hội loài người.",
      hint: "Điều này liên quan đến 'quy luật khách quan' của lịch sử.",
    },
    {
      question:
        "Đặc điểm của cuộc cách mạng xã hội chủ nghĩa ở Việt Nam là gì?",
      options: [
      ...
      explanation:
        "Cách mạng Việt Nam có tính đặc thù là kết hợp ba nhiệm vụ giải phóng cùng lúc.",
      hint: "Ba nhiệm vụ 'giải phóng' được thực hiện đồng thời.",
    },
    {
      question:
        "Vai trò của Đảng Cộng sản trong quá trình xây dựng chủ nghĩa xã hội ở Việt Nam?",
      options: [
      ...
      explanation:
        "Đảng Cộng sản Việt Nam là lực lượng lãnh đạo toàn diện của cách mạng và xây dựng đất nước.",
      hint: "Sự lãnh đạo này mang tính 'toàn diện' và 'tổng thể'.",
    },
    {
      question:
        "Nguyên nhân sâu xa của sự ra đời chủ nghĩa xã hội khoa học là gì?",
      options: [
      ...
      explanation:
        "Chủ nghĩa xã hội khoa học ra đời từ những mâu thuẫn khách quan của chủ nghĩa tư bản và đấu tranh giai cấp công nhân.",
...
var QuizGameSimple = {
  ...
  globalClickHandler: function (e) {
    ...
    if (
      target.id === "back-to-mode-selection" ||
      target.closest("#back-to-mode-selection")
    ) {
      e.preventDefault();
      e.stopPropagation();
    ...
    if (
      target.id === "back-to-menu-study" ||
      target.closest("#back-to-menu-study")
    ) {
      e.preventDefault();
      this.showGameMenu();
      return;
  ...
  showDifficultySelection: function (mode) {
    ...
    if (difficultyScreen) {
      ...
      var descriptions = {
        classic:
          "Chế độ Cổ điển - Hãy chọn độ khó phù hợp với trình độ của bạn",
      ...
      if (descElement) {
        descElement.textContent =
          descriptions[mode] ||
          "Hãy chọn mức độ khó phù hợp với trình độ của bạn";
      }
    } else {
...
function generateQuestions(mode, difficulty) {
  ...
  if (difficulty === "mixed") {
    ...
    console.log(
      "Mixed difficulty breakdown - Easy:",
      easyCount,
      "Medium:",
      mediumCount,
      "Hard:",
    ...
    questions = questions.concat(
      getRandomQuestions(questionBank.easy, easyCount)
    );
    questions = questions.concat(
      getRandomQuestions(questionBank.medium, mediumCount)
    );
    questions = questions.concat(
      getRandomQuestions(questionBank.hard, hardCount)
    );
...
function selectAnswer(selectedIndex) {
  ...
  setTimeout(function () {
    ...
    if (!isCorrect && selectedIndex >= 0) {
      ...
      if (gameState.mode === "survival") {
        ...
        if (gameState.lives <= 0) {
          ...
          gameState.answers.push({
            ...
            isCorrect: isCorrect,
            timeUsed:
              gameModes[gameState.mode].timePerQuestion - gameState.timeLeft,
      ...
      var totalScore = Math.floor(
        (baseScore + comboBonus + timeBonus) *
          gameModes[gameState.mode].scoreMultiplier
      );
...
function useFiftyFifty() {
  ...
  console.log(
    "50:50 hiding indices:",
    toHide,
    "Correct answer at:",
    mapping.findIndex((m) => m.isCorrect)
  );
  ...
  var fiftyFiftyMessage =
    "🎯 TRỢ GIÚP 50:50 ĐÃ KÍCH HOẠT\n\n❌ Đã loại bỏ 2 đáp án sai\n\n💰 Chi phí: 200 điểm";
...
function useDoubleScore() {
  var doubleScoreMessage =
    "⭐ ĐIỂM SỐ X2 ĐÃ KÍCH HOẠT\n\n🎯 Câu trả lời đúng sẽ được nhân đôi điểm!\n\n💰 Chi phí: 100 điểm";
...
function generateResultsReview() {
  ...
  for (var i = 0; i < gameState.answers.length; i++) {
    ...
    if (!answer.isCorrect) {
      reviewHTML +=
        '<br><em style="color: #3498db;">' + question.explanation + "</em>";
    }
...
function showAlert(message, type) {
  ...
  var existingAlerts = document.querySelectorAll(
    '.game-alert[data-type="' + type + '"]'
  );
  ...
  setTimeout(
    ...
    type === "info" ? 6000 : 4000
  ); // Info alerts (expert tips) stay longer
}
...
document.addEventListener("keydown", function (e) {
  var gamePlayingVisible =
    document.getElementById("game-playing") &&
    document.getElementById("game-playing").style.display !== "none";
  ...
  if (gamePlayingVisible) {
    if (e.key >= "1" && e.key <= "4") {
      ...
      if (
        options[answerIndex] &&
        !options[answerIndex].classList.contains("disabled")
      ) {
    ...
    questions: [
      {
        ...
        topic: "Cơ cấu xã hội",
        explanation:
          "Cơ cấu xã hội - giai cấp có vị trí quan trọng hàng đầu vì liên quan đến sở hữu tư liệu sản xuất và quyền lực trong xã hội.",
      },
      {
        question: "Cơ cấu xã hội bao gồm những cơ cấu nào?",
        options: [
      ...
      },
      {
        ...
        topic: "Cơ cấu xã hội",
        explanation:
          "Cơ cấu xã hội là tổng thể các mối quan hệ bền vững giữa các nhóm xã hội, được hình thành do vị trí của các nhóm trong hệ thống quan hệ xã hội nhất định.",
      },
    ],
  },
  alliance: {
    ...
    questions: [
      {
        ...
        topic: "Liên minh giai cấp",
        explanation:
          "Liên minh Công nhân - Nông dân - Trí thức là liên minh cơ bản trong xã hội Việt Nam hiện đại.",
      },
      {
        question: "Trong liên minh giai cấp cơ bản, ai là lực lượng lãnh đạo?",
        options: [
        ...
        topic: "Liên minh giai cấp",
        explanation:
          "Giai cấp công nhân là lực lượng lãnh đạo trong liên minh giai cấp cơ bản vì đại diện cho phương thức sản xuất tiên tiến.",
      },
    ],
  },
  vietnam: {
    ...
    questions: [
      {
        question:
          "Đặc điểm nào sau đây thuộc về giai cấp công nhân Việt Nam hiện đại?",
        options: [
          "Lãnh đạo cách mạng, đại diện cho phương thức sản xuất tiên tiến",
          "Sở hữu tư liệu sản xuất lớn",
          "Chỉ làm việc trong nông nghiệp",
        ...
        explanation:
          "Giai cấp công nhân Việt Nam là lực lượng lãnh đạo cách mạng và đại diện cho phương thức sản xuất tiên tiến nhất trong xã hội hiện đại.",
      },
      {
        question: "Vai trò của giai cấp nông dân trong xã hội Việt Nam là gì?",
        options: [
        ...
        explanation:
          "Giai cấp nông dân đóng vai trò là bệ đỡ kinh tế, đảm bảo an ninh lương thực và xuất khẩu nông sản quan trọng.",
      },
      {
        question:
          "Sự biến đổi cơ cấu xã hội của Việt Nam sau Đổi mới thể hiện như thế nào?",
        options: [
        ...
        explanation:
          "Sau Đổi mới, cơ cấu xã hội Việt Nam có sự biến đổi sâu sắc theo hướng đa dạng hóa các thành phần kinh tế và giai cấp xã hội.",
      },
      {
        question:
          "Xu hướng chủ yếu trong biến đổi cơ cấu xã hội ở Việt Nam hiện nay là gì?",
        options: [
        ...
        explanation:
          "Xu hướng chủ yếu là tăng tỷ trọng lao động trong công nghiệp và dịch vụ, đồng thời giảm tỷ trọng lao động nông nghiệp, phản ánh quá trình công nghiệp hóa, hiện đại hóa đất nước.",
      },
    ],
  },
};
...
function showTopicContent(topic) {
  ...
  if (!topicData) {
    contentContainer.innerHTML =
      '<div style="text-align: center; padding: 2rem; color: red;">Không tìm thấy nội dung cho chủ đề này!</div>';
    return;
  }
  ...
  if (topic === "structure") {
    ...
    if (topicDescription)
      topicDescription.textContent =
        "Tìm hiểu về khái niệm, đặc điểm và vai trò của các loại cơ cấu trong xã hội.";
  } else if (topic === "alliance") {
    if (topicSubtitle) topicSubtitle.textContent = "Liên minh giai cấp";
    if (topicDescription)
      topicDescription.textContent =
        "Khám phá vai trò và ý nghĩa lịch sử của liên minh giai cấp trong phát triển xã hội.";
  } else if (topic === "vietnam") {
    if (topicSubtitle) topicSubtitle.textContent = "Thực tiễn Việt Nam";
    if (topicDescription)
      topicDescription.textContent =
        "Phân tích sự biến đổi cơ cấu xã hội qua các giai đoạn lịch sử Việt Nam.";
  }
...
function createSimpleTopicContent(topic, topicData, container) {
  ...
  if (topic === "structure") {
    introText =
      "Cơ cấu xã hội là nền tảng để hiểu biết về các mối quan hệ xã hội.";
  } else if (topic === "alliance") {
    introText =
      "Liên minh giai cấp là khái niệm quan trọng trong phân tích xã hội.";
  } else if (topic === "vietnam") {
    introText =
      "Việt Nam đã trải qua nhiều biến đổi về cơ cấu xã hội qua lịch sử.";
  }
  ...
  // Add introduction
  content +=
    '<div style="background: #f8f9fa; padding: 1.5rem; border-radius: 8px; margin-bottom: 2rem; border-left: 4px solid #d63031;">';
  content +=
    '<h4 style="color: #d63031; margin-bottom: 1rem;"><i class="fas fa-info-circle"></i> Giới thiệu</h4>';
  content +=
...
function createSimpleQuestionCard(question, questionNumber) {
  ...
  // Question card
  card +=
    '<div style="background: white; border-radius: 12px; padding: 2rem; margin-bottom: 2rem; box-shadow: 0 4px 15px rgba(0,0,0,0.1); border: 1px solid #e9ecef;">';

  // Question header with number and topic
  card +=
    '<div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.5rem;">';
  card +=
    '<div style="background: #d63031; color: white; border-radius: 50%; width: 40px; height: 40px; display: flex; align-items: center; justify-content: center; font-weight: bold;">' +
    questionNumber +
    "</div>";
  card +=
    '<div style="background: #e3f2fd; color: #1976d2; padding: 0.5rem 1rem; border-radius: 20px; font-size: 0.9rem; font-weight: 600;">' +
    question.topic +
    "</div>";
  card += "</div>";
  ...
  // Question text
  card +=
    '<h4 style="color: #333; margin-bottom: 1.5rem; font-size: 1.2rem; line-height: 1.5;">' +
    question.question +
    "</h4>";
  ...
  for (var i = 0; i < question.options.length; i++) {
    ...
    card +=
      '<div style="background: ' +
      (isCorrect ? "#28a745" : "#6c757d") +
      '; color: white; border-radius: 50%; width: 30px; height: 30px; display: flex; align-items: center; justify-content: center; font-weight: bold; font-size: 0.9rem;">' +
      letters[i] +
      "</div>";
    card +=
      '<div style="color: ' +
  ...
  card +=
    '<h5 style="color: #856404; margin-bottom: 0.8rem;"><i class="fas fa-lightbulb"></i> Giải thích</h5>';
  card +=
